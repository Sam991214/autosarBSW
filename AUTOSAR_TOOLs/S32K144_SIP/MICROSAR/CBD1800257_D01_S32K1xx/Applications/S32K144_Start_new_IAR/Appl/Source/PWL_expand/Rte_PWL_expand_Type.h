 ...
 *       License:  CBD1800257
 *
 *   Description:  Application types header file for SW-C <PWL_expand> (Contract Phase)
 *********************************************************************************************************************/

/* double include prevention */
#ifndef _RTE_PWL_EXPAND_TYPE_H
# define _RTE_PWL_EXPAND_TYPE_H
