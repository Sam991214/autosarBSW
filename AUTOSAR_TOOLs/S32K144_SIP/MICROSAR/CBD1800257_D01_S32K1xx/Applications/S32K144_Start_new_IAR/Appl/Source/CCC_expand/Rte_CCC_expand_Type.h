 ...
 *       License:  CBD1800257
 *
 *   Description:  Application types header file for SW-C <CCC_expand> (Contract Phase)
 *********************************************************************************************************************/

/* double include prevention */
#ifndef _RTE_CCC_EXPAND_TYPE_H
# define _RTE_CCC_EXPAND_TYPE_H
