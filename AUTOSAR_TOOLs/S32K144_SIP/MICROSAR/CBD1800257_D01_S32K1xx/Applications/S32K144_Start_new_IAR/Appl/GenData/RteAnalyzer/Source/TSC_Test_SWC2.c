...
{
  return Rte_Read_lwt_Test_Swc2_Read_u8_Signal_lwt(data);
}
...
{
  return Rte_Write_lwt_Test_Swc2_Write_u8_Signal_lwt(data);
}
...
{
  return Rte_Call_Test_SWC_Service_Operation_lwt(arg_in_lwt, arg_out_lwt);
}
