...
extern OS_STACK_DECLARE(OsCfg_Stack_OsTask_EMC_PWL_CCC_Dyn, OS_CFG_SIZE_OSTASK_EMC_PWL_CCC_STACK);
...
extern CONST(Os_StackConfigType, OS_CONST) OsCfg_Stack_OsTask_EMC_PWL_CCC;
