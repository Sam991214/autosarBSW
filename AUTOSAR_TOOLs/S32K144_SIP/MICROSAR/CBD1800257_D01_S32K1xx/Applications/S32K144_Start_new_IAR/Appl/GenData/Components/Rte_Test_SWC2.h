...
#  define Rte_Read_Test_SWC2_lwt_Test_Swc2_Read_u8_Signal_lwt(data) (*(data) = Rte_Test_SWC_lwt_Test_Swc_Write_u8_Signal_lwt, ((Std_ReturnType)RTE_E_OK)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
...
#  define Rte_Write_Test_SWC2_lwt_Test_Swc2_Write_u8_Signal_lwt(data) (Rte_Test2_SWC_lwt_Test_Swc2_Write_u8_Signal_lwt = (data), ((Std_ReturnType)RTE_E_OK)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
...
#  include "MemMap.h" /* PRQA S 5087 */ /* MD_MSR_19.1 */
FUNC(void, RTE_TEST_SWC_APPL_CODE) Test_SWC_Service_Operation_lwt(uint8 arg_in_lwt, P2VAR(uint8, AUTOMATIC, RTE_TEST_SWC_APPL_VAR) arg_out_lwt); /* PRQA S 0850 */ /* MD_MSR_19.8 */
#  define RTE_STOP_SEC_TEST_SWC_APPL_CODE
#  include "MemMap.h" /* PRQA S 5087 */ /* MD_MSR_19.1 */

#  define Rte_Call_Test_SWC_Service_Operation_lwt(arg1, arg2) (Test_SWC_Service_Operation_lwt(arg1, arg2), ((Std_ReturnType)RTE_E_OK)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
...
FUNC(void, Test_SWC2_CODE) Test_SWC2_Main(void); /* PRQA S 0850, 3451 */ /* MD_MSR_19.8, MD_Rte_3451 */
