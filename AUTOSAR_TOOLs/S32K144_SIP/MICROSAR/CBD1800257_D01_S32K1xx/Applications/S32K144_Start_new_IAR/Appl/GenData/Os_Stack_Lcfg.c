...
/* User: [Adc_ConvertGroup0_lwt, CanIsr_0_BusOff, CanIsr_0_MB00To15, CanIsr_0_MB16To31, CounterIsr_SystemTimer, Gptlsr_LpitChannel0] */
...
#define OS_START_SEC_STACK_OSTASK_EMC_PWL_CCC_VAR_NOINIT_UNSPECIFIED
#include "Os_MemMap_Stacks.h" /* PRQA S 5087 */ /* MD_MSR_19.1 */

/* Shared Task stack: OsTask_EMC_PWL_CCC */
/* User: [OsTask_EMC_PWL_CCC] */
OS_STACK_DECLARE(OsCfg_Stack_OsTask_EMC_PWL_CCC_Dyn, OS_CFG_SIZE_OSTASK_EMC_PWL_CCC_STACK);

#define OS_STOP_SEC_STACK_OSTASK_EMC_PWL_CCC_VAR_NOINIT_UNSPECIFIED
#include "Os_MemMap_Stacks.h" /* PRQA S 5087 */ /* MD_MSR_19.1 */
...
/*! Stack configuration data: OsTask_EMC_PWL_CCC */
CONST(Os_StackConfigType, OS_CONST) OsCfg_Stack_OsTask_EMC_PWL_CCC =
{
  /* .LowAddress  = */ OS_STACK_GETLOWADDRESS(OsCfg_Stack_OsTask_EMC_PWL_CCC_Dyn),
  /* .HighAddress = */ OS_STACK_GETHIGHADDRESS(OsCfg_Stack_OsTask_EMC_PWL_CCC_Dyn)
};
