...
# define Rte_Ev_Run_CCC_CCC_expand_Runnable_2S     ((EventMaskType)1ULL)
...
# define Rte_Ev_Run_EMC_EMC_expand_Runnable_10ms     ((EventMaskType)2ULL)
# define Rte_Ev_Run_PWL_PWL_expand_Runnable_20ms     ((EventMaskType)4ULL)
