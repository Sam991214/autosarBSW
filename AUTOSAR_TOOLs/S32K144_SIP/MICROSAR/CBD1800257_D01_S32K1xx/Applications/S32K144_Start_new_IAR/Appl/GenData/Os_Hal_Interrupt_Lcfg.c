...
CONST(Os_Hal_IntIsrConfigType, OS_CONST) OsCfg_Hal_IntIsr_Adc_ConvertGroup0_lwt =
{
  /* .Level  = */ 70uL,
...
CONST(Os_Hal_IntIsrConfigType, OS_CONST) OsCfg_Hal_IntIsr_Gptlsr_LpitChannel0 =
{
  /* .Level  = */ 71uL,
