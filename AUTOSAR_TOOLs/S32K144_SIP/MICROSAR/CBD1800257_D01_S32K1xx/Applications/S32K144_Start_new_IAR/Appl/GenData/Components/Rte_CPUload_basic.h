 ...
 *       License:  CBD1800257
 *
 *   Description:  Application header file for SW-C <CPUload_basic>
 *********************************************************************************************************************/
...
FUNC(void, CPUload_basic_CODE) CPUload_basic_Runnable_1S(void); /* PRQA S 0850, 3451 */ /* MD_MSR_19.8, MD_Rte_3451 */
