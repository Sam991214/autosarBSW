 ...
 *       License:  CBD1800257
 *
 *   Description:  Application header file for SW-C <PWL_expand>
 *********************************************************************************************************************/
...
FUNC(void, PWL_expand_CODE) PWL_expand_Runnable_20ms(void); /* PRQA S 0850, 3451 */ /* MD_MSR_19.8, MD_Rte_3451 */
