...
extern CONST(Os_Hal_ContextConfigType, OS_CONST) OsCfg_Hal_Context_Adc_ConvertGroup0_lwt;
...
extern CONST(Os_Hal_ContextConfigType, OS_CONST) OsCfg_Hal_Context_Gptlsr_LpitChannel0;
