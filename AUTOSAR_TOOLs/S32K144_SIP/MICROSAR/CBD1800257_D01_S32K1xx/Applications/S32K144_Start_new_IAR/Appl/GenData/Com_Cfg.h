 ...
 *  -------------------------------------------------------------------------------------------------------------------
 *              File: Com_Cfg.h
 *   Generation Time: 2025-12-12 00:27:15
...
#define ComConf_ComSignal_lwt_sig_recv2_RearLeftWinPos_olwt_msg_recv2_oCAN00_1d859839_Rx 0u
#define ComConf_ComSignal_lwt_sig_recv2_RearRightWinPos_olwt_msg_recv2_oCAN00_b5508b86_Rx 1u
...
/* Handle IDs active in all predefined variants (the application has not to take the active variant into account) */
/*      Symbolic Name                                                 Value   Active in predefined variant(s) */
#define ComConf_ComGroupSignal_lwt_sig_group_000                      2u
#define ComConf_ComGroupSignal_lwt_sig_group_001                      3u
#define ComConf_ComSignal_RearLeft_window_LWT                         0u
#define ComConf_ComSignal_RearRight_window_case1                      1u
#define ComConf_ComSignal_lwt_sig_trans2_FrongLight_olwt_msg_transmit2_oCAN00_65e2995e_Tx 4u
...
/* Handle IDs active in all predefined variants (the application has not to take the active variant into account) */
/*      Symbolic Name                                                 Value   Active in predefined variant(s) */
#define ComConf_ComSignalGroup_lwt_ComSignalGroup                     0u
/**\} */
...
#define Com_GetSizeOfRxAccessInfoReplaceSigIndOfPCConfig()            1u  /**< the number of accomplishable value elements in Com_RxAccessInfoReplaceSigInd */
...
#define Com_GetSizeOfTxBufferOfPCConfig()                             30u  /**< the number of accomplishable value elements in Com_TxBuffer */
...
#define Com_GetSizeOfTxSigGrpMaskOfPCConfig()                         5u  /**< the number of accomplishable value elements in Com_TxSigGrpMask */
...
#define Com_IsRxTOutInfoUsedOfRxAccessInfo(Index)                     ((Com_GetRxAccessInfoOfPCConfig()[(Index)].RxTOutInfoUsedOfRxAccessInfo) != FALSE)
...
#define Com_IsRxAccessInfoReplaceSigIndUsedOfRxTOutInfo(Index)        ((Com_GetRxTOutInfoOfPCConfig()[(Index)].RxAccessInfoReplaceSigIndUsedOfRxTOutInfo) != FALSE)
...
#define Com_GetApplTypeOfRxAccessInfo(Index)                          ((Com_ApplTypeOfRxAccessInfoType)((Com_GetInitValueIdxOfRxAccessInfo(Index) - 1u)))  /**< Application data type. */
...
#define Com_GetRxDataTimeoutSubstitutionValueIdxOfRxAccessInfo(Index) Com_GetRxTOutInfoIdxOfRxAccessInfo(Index)  /**< the index of the 0:1 relation pointing to Com_ConstValueUInt8,Com_ConstValueUInt16,Com_ConstValueUInt32,Com_ConstValueUInt64,Com_ConstValueSInt8,Com_ConstValueSInt16,Com_ConstValueSInt32,Com_ConstValueSInt64,Com_ConstValueFloat32,Com_ConstValueFloat64 */
#define Com_IsRxDataTimeoutSubstitutionValueUsedOfRxAccessInfo(Index) Com_IsRxTOutInfoUsedOfRxAccessInfo(Index)  /**< TRUE, if the 0:1 relation has minimum 1 relation pointing to Com_ConstValueUInt8,Com_ConstValueUInt16,Com_ConstValueUInt32,Com_ConstValueUInt64,Com_ConstValueSInt8,Com_ConstValueSInt16,Com_ConstValueSInt32,Com_ConstValueSInt64,Com_ConstValueFloat32,Com_ConstValueFloat64 */
...
#define Com_GetRxAccessInfoReplaceSigInd(Index)                       ((Com_RxAccessInfoReplaceSigIndType)((Index)))  /**< the indexes of the 1:1 sorted relation pointing to Com_RxAccessInfo */
...
#define Com_IsCbkRxTOutFuncPtrIndUsedOfRxTOutInfo(Index)              Com_IsRxAccessInfoReplaceSigIndUsedOfRxTOutInfo(Index)  /**< TRUE, if the 0:n relation has 1 relation pointing to Com_CbkRxTOutFuncPtrInd */
...
#define Com_GetRxAccessInfoReplaceSigIndEndIdxOfRxTOutInfo(Index)     ((Com_RxAccessInfoReplaceSigIndEndIdxOfRxTOutInfoType)((((Com_RxAccessInfoReplaceSigIndEndIdxOfRxTOutInfoType)(Index)) + 1u)))  /**< the end index of the 0:n relation pointing to Com_RxAccessInfoReplaceSigInd */
#define Com_GetRxAccessInfoReplaceSigIndStartIdxOfRxTOutInfo(Index)   ((Com_RxAccessInfoReplaceSigIndStartIdxOfRxTOutInfoType)((Index)))  /**< the start index of the 0:n relation pointing to Com_RxAccessInfoReplaceSigInd */
...
#define Com_GetTxBufferEndIdxOfTxSigGrpInfo(Index)                    ((Com_TxBufferEndIdxOfTxSigGrpInfoType)((((Com_TxBufferEndIdxOfTxSigGrpInfoType)(Index)) + 30u)))  /**< the end index of the 0:n relation pointing to Com_TxBuffer */
#define Com_GetTxBufferLengthOfTxSigGrpInfo(Index)                    ((Com_TxBufferLengthOfTxSigGrpInfoType)((((Com_TxBufferLengthOfTxSigGrpInfoType)(Index)) + 5u)))  /**< the number of relations pointing to Com_TxBuffer */
#define Com_GetTxBufferSigGrpInTxIPDUEndIdxOfTxSigGrpInfo(Index)      ((Com_TxBufferSigGrpInTxIPDUEndIdxOfTxSigGrpInfoType)((((Com_TxBufferSigGrpInTxIPDUEndIdxOfTxSigGrpInfoType)(Index)) + 15u)))  /**< the end index of the 1:n relation pointing to Com_TxBuffer */
#define Com_GetTxBufferSigGrpInTxIPDULengthOfTxSigGrpInfo(Index)      ((Com_TxBufferSigGrpInTxIPDULengthOfTxSigGrpInfoType)((((Com_TxBufferSigGrpInTxIPDULengthOfTxSigGrpInfoType)(Index)) + 5u)))  /**< the number of relations pointing to Com_TxBuffer */
#define Com_GetTxBufferSigGrpInTxIPDUStartIdxOfTxSigGrpInfo(Index)    ((Com_TxBufferSigGrpInTxIPDUStartIdxOfTxSigGrpInfoType)((((Com_TxBufferSigGrpInTxIPDUStartIdxOfTxSigGrpInfoType)(Index)) + 10u)))  /**< the start index of the 1:n relation pointing to Com_TxBuffer */
...
#define Com_GetTxPduInfoIdxOfTxSigGrpInfo(Index)                      ((Com_TxPduInfoIdxOfTxSigGrpInfoType)((((Com_TxPduInfoIdxOfTxSigGrpInfoType)(Index)) + 2u)))  /**< the index of the 1:1 relation pointing to Com_TxPduInfo */
#define Com_GetTxSigGrpMaskEndIdxOfTxSigGrpInfo(Index)                ((Com_TxSigGrpMaskEndIdxOfTxSigGrpInfoType)((((Com_TxSigGrpMaskEndIdxOfTxSigGrpInfoType)(Index)) + 5u)))  /**< the end index of the 0:n relation pointing to Com_TxSigGrpMask */
#define Com_GetTxSigGrpMaskLengthOfTxSigGrpInfo(Index)                ((Com_TxSigGrpMaskLengthOfTxSigGrpInfoType)((((Com_TxSigGrpMaskLengthOfTxSigGrpInfoType)(Index)) + 5u)))  /**< the number of relations pointing to Com_TxSigGrpMask */
...
/**   \brief  type used to iterate Com_RxAccessInfoReplaceSigInd */
typedef uint8_least Com_RxAccessInfoReplaceSigIndIterType;
...
/**   \brief  value based type definition for Com_RxAccessInfoReplaceSigInd */
...
/**   \brief  value based type definition for Com_RxAccessInfoReplaceSigIndEndIdxOfRxTOutInfo */
typedef uint8 Com_RxAccessInfoReplaceSigIndEndIdxOfRxTOutInfoType;

/**   \brief  value based type definition for Com_RxAccessInfoReplaceSigIndStartIdxOfRxTOutInfo */
typedef uint8 Com_RxAccessInfoReplaceSigIndStartIdxOfRxTOutInfoType;

/**   \brief  value based type definition for Com_RxAccessInfoReplaceSigIndUsedOfRxTOutInfo */
...
/**   \brief  value based type definition for Com_SizeOfRxAccessInfoReplaceSigInd */
...
typedef struct sCom_RxAccessInfoType
{
  ...
  Com_RxTOutInfoUsedOfRxAccessInfoType RxTOutInfoUsedOfRxAccessInfo;  /**< TRUE, if the 0:1 relation has minimum 1 relation pointing to Com_RxTOutInfo */
...
{
  Com_RxAccessInfoReplaceSigIndUsedOfRxTOutInfoType RxAccessInfoReplaceSigIndUsedOfRxTOutInfo;  /**< TRUE, if the 0:n relation has 1 relation pointing to Com_RxAccessInfoReplaceSigInd */
} Com_RxTOutInfoType;
...
{
  Com_HandleRxPduDeferredType lwt_msg_recv2_oCAN00_700d1e50_Rx;
...
{
  Com_RxDefPduBufferType lwt_msg_recv2_oCAN00_700d1e50_Rx[8];
...
/**   \brief  type used to point to Com_RxAccessInfoReplaceSigInd */
typedef P2CONST(Com_RxAccessInfoReplaceSigIndType, TYPEDEF, COM_CONST) Com_RxAccessInfoReplaceSigIndPtrType;
...
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_MemMap */
/*lint -restore */
extern CONST(Com_RxTOutInfoType, COM_CONST) Com_RxTOutInfo[1];
#define COM_STOP_SEC_CONST_UNSPECIFIED
/*lint -save -esym(961, 19.1) */
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_MemMap */
/*lint -restore */
...
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_MemMap */
/*lint -restore */
extern CONST(Com_TxSigGrpMaskType, COM_CONST) Com_TxSigGrpMask[5];
#define COM_STOP_SEC_CONST_8BIT
/*lint -save -esym(961, 19.1) */
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_MemMap */
/*lint -restore */
...
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_MemMap */
/*lint -restore */
extern VAR(Com_TxBufferType, COM_VAR_NOINIT) Com_TxBuffer[30];
#define COM_STOP_SEC_VAR_NOINIT_8BIT
/*lint -save -esym(961, 19.1) */
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_MemMap */
/*lint -restore */
