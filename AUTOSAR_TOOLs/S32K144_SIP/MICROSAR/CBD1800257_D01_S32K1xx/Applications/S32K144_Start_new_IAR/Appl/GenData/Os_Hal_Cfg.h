...
# define OS_ISR_ADC_CONVERTGROUP0_LWT_CORE      (0)
# define OS_ISR_ADC_CONVERTGROUP0_LWT_LEVEL     (70)
...
# define OS_ISR_GPTLSR_LPITCHANNEL0_CORE      (0)
# define OS_ISR_GPTLSR_LPITCHANNEL0_LEVEL     (71)
