...
/*! Dynamic ISR data: Adc_ConvertGroup0_lwt */
OS_LOCAL VAR(Os_IsrType, OS_VAR_NOINIT) OsCfg_Isr_Adc_ConvertGroup0_lwt_Dyn;
...
/*! Dynamic ISR data: Gptlsr_LpitChannel0 */
OS_LOCAL VAR(Os_IsrType, OS_VAR_NOINIT) OsCfg_Isr_Gptlsr_LpitChannel0_Dyn;
...
/*! ISR configuration data: Adc_ConvertGroup0_lwt */
CONST(Os_IsrConfigType, OS_CONST) OsCfg_Isr_Adc_ConvertGroup0_lwt =
{
  /* .Thread   = */
  {
    /* .ContextConfig         = */ &OsCfg_Hal_Context_Adc_ConvertGroup0_lwt,
    /* .Context               = */ &OsCfg_Hal_Context_OsCore0_Isr_Level5_Dyn,
    /* .Stack                 = */ &OsCfg_Stack_OsCore0_Isr_Core,
    /* .Dyn                   = */ OS_ISR_CASTDYN_ISR_2_THREAD(OsCfg_Isr_Adc_ConvertGroup0_lwt_Dyn),
  ...
  /* .HwConfig = */ &OsCfg_Hal_IntIsr_Adc_ConvertGroup0_lwt,
  /* .IsrId    = */ Adc_ConvertGroup0_lwt
};
...
/*! ISR configuration data: Gptlsr_LpitChannel0 */
CONST(Os_IsrConfigType, OS_CONST) OsCfg_Isr_Gptlsr_LpitChannel0 =
{
  /* .Thread   = */
  {
    /* .ContextConfig         = */ &OsCfg_Hal_Context_Gptlsr_LpitChannel0,
    /* .Context               = */ &OsCfg_Hal_Context_OsCore0_Isr_Level4_Dyn,
    /* .Stack                 = */ &OsCfg_Stack_OsCore0_Isr_Core,
    /* .Dyn                   = */ OS_ISR_CASTDYN_ISR_2_THREAD(OsCfg_Isr_Gptlsr_LpitChannel0_Dyn),
    /* .OwnerApplication      = */ &OsCfg_App_SystemApplication_OsCore0,
    /* .Core                  = */ &OsCfg_Core_OsCore0,
    /* .IntApiState           = */ &OsCfg_Core_OsCore0_Dyn.IntApiState,
    /* .TimeProtConfig        = */ NULL_PTR,
  ...
  /* .HwConfig = */ &OsCfg_Hal_IntIsr_Gptlsr_LpitChannel0,
  /* .IsrId    = */ Gptlsr_LpitChannel0
};
...
{
  OS_ISR_CASTCONFIG_ISR_2_ISR(OsCfg_Isr_Adc_ConvertGroup0_lwt),
  ...
  OS_ISR_CASTCONFIG_ISR_2_ISR(OsCfg_Isr_Gptlsr_LpitChannel0),
  NULL_PTR
};
