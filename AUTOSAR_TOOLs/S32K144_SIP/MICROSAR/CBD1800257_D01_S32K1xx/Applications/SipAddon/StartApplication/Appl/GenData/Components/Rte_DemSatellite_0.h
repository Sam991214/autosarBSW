...
# endif
# ifdef RTE_PTR2ARRAYBASETYPE_PASSING
FUNC(Std_ReturnType, RTE_CODE) Rte_Call_DemSatellite_0_CBReadData_PID_0x14_DID_Data_ReadData(P2VAR(uint8, AUTOMATIC, RTE_DEMSATELLITE_0_APPL_VAR) Data); /* PRQA S 0850, 3451 */ /* MD_MSR_19.8, MD_Rte_3451 */
# else
FUNC(Std_ReturnType, RTE_CODE) Rte_Call_DemSatellite_0_CBReadData_PID_0x14_DID_Data_ReadData(P2VAR(DataArrayType_uint8_2, AUTOMATIC, RTE_DEMSATELLITE_0_APPL_VAR) Data); /* PRQA S 0850, 3451 */ /* MD_MSR_19.8, MD_Rte_3451 */
# endif
...
#  define Rte_Call_CBReadData_PID_0x14_DID_Data_ReadData Rte_Call_DemSatellite_0_CBReadData_PID_0x14_DID_Data_ReadData
...
#  define RTE_E_CSDataServices_PID_0x14_DID_Data_E_NOT_OK (1U)
