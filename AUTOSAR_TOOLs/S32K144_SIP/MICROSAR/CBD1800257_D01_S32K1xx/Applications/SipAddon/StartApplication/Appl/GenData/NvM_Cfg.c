...
static VAR(uint8, NVM_PRIVATE_DATA) NvMBlockDescriptor_ComM_Crc_au8[2uL]; 
...
NVM_CRC_COMP_MECHANISM_OFF
      ...
      { /*  NvMBlockDescriptor_ComM  */ 
        (NvM_RamAddressType)&ComM_Inhibition /*  pointer to the RAM data buffer  */ , 
        NULL_PTR /*  pointer to the ROM buffer  */ , 
        NULL_PTR /*  pointer to the Init Callback function  */ , 
        Dem_NvM_JobFinished /*  pointer to the job End Callback function  */ , 
        NULL_PTR /*  pointer to the ReadRamBlockFromNvCallback  */ , 
        NULL_PTR /*  pointer to the WriteRamBlockToNvCallback  */ , 
        NvMBlockDescriptor_ComM_Crc_au8 /*  pointer to the CRC data buffer  */ , 
...
NVM_CRC_COMP_MECHANISM_OFF
      ...
      { /*  StartApplication_NvMBlock2  */ 
        ...
        NULL_PTR /*  pointer to the ROM buffer  */ , 
        NULL_PTR /*  pointer to the Init Callback function  */ , 
        Rte_Call_NvM_RpNotifyJobEnd_StartApplication_NvMBlock2_JobFinished /*  pointer to the job End Callback function  */ , 
        NULL_PTR /*  pointer to the ReadRamBlockFromNvCallback  */ , 
        NULL_PTR /*  pointer to the WriteRamBlockToNvCallback  */ , 
        NULL_PTR /*  pointer to the CRC data buffer  */ , 
...
NVM_CRC_COMP_MECHANISM_OFF
      ...
      { /*  StartApplication_NvMBlock1  */ 
        ...
        NULL_PTR /*  pointer to the ROM buffer  */ , 
        NULL_PTR /*  pointer to the Init Callback function  */ , 
        Rte_Call_NvM_RpNotifyJobEnd_StartApplication_NvMBlock1_JobFinished /*  pointer to the job End Callback function  */ , 
        NULL_PTR /*  pointer to the ReadRamBlockFromNvCallback  */ , 
        NULL_PTR /*  pointer to the WriteRamBlockToNvCallback  */ , 
        NULL_PTR /*  pointer to the CRC data buffer  */ , 
