...
static VAR(Spi_DataBufferType, SPI_VAR) BufferTX_PBSpiChannel_0[1];
static VAR(Spi_DataBufferType, SPI_VAR) BufferRX_PBSpiChannel_0[1];
...
{
    {
                ...
                SPI_SpiExternalDevice_0, /* External Device */
        {
          ...
          { /* TCR register configuration */
            ...
            LPSPI_TCR_PRESCALE_2_U32 /* Baudrate: Should=100000.0, Is=100000, Error=0.0% */
     ...
     { /* CCR register configuration */
            /* Normal Mode */
            ( ((uint32)(23) << 24u) | /* TimeClk2Cs: Should=1000ns, Is=1000, Error=0.0% */
            ((uint32)(23) << 16u) | /* TimeCs2Clk: Should=1000ns, Is=1000, Error=0.0% */
            ((uint32)(23) << 8u) | /* TimeCs2Cs: Should=1000ns, Is=1000, Error=0.0% */
            ((uint32)(238))
            ),
            /* Alternate Mode */
            ( ((uint32)(23) << 24u) | /* TimeClk2Cs: Should=1000ns, Is=1000, Error=0.0% */
...
static CONST(Spi_HWUnitConfigType, SPI_CONST) HWUnitConfig_PB[SPI_MAX_HWUNIT] =
{
    ...
    { LPSPI_0_OFFSET, (uint8)0u, (uint8)SPI_MASTER , SPI_PHYUNIT_SYNC_U32 }
};
