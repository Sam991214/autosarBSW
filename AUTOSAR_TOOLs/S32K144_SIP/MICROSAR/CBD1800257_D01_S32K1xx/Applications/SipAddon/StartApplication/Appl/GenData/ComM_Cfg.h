...
#define COMM_NVM_SUPPORT                                STD_ON
#define COMM_NVM_BLOCK_ID                               NvMConf_NvMBlockDescriptor_NvMBlockDescriptor_ComM
...
#define ComMConf_ComMUser_CN_CAN_52ce3533 0u 
...
#define ComMConf_ComMChannel_CN_CAN_fe6ecc87 0u 
...
{
  ComM_MinFullComModeTimerType ComMChannel_0[1];
