...
#include "MemMap.h" /* PRQA S 5087 */ /* MD_MSR_19.1 */ 
/* RAM section for supervisedEntity 'WdgMSupervisedEntity_Dummy' */ 
...
#include "MemMap.h" /* PRQA S 5087 */ /* MD_MSR_19.1 */ 
/* Local Alive Counters for checkpoint 'WdgMCheckpoint_Dummy' in 'WdgMSupervisedEntity_Dummy' */ 
...
/* Global Alive Counters for checkpoint 'WdgMCheckpoint_Dummy' in supervised entity 'WdgMSupervisedEntity_Dummy' */ 
...
{
  {
    WdgMConf_WdgMCheckpoint_WdgMCheckpoint_Dummy /*  WdgMCheckpointId  */ , 
    FALSE /*  WdgMIsEndCheckpoint  */ , 
    FALSE /*  WdgMIsEndCheckpointGlobal  */ , 
    10u /*  WdgMExpectedAliveIndications  */ , 
    10u /*  WdgMMinMargin  */ , 
    10u /*  WdgMMaxMargin  */ , 
    65535u /*  WdgMSupervisionReferenceCycle  */ , 
...
{
  {
    WdgMConf_WdgMSupervisedEntity_WdgMSupervisedEntity_Dummy /*  WdgMSupervisedEntity  */ , 
    FALSE /*  WdgMEnableEntityDeactivation  */ , 
    WdgMConf_WdgMCheckpoint_WdgMCheckpoint_Dummy /*  WdgMCheckpointLocInitialId  */ , 
    1u /*  NrOfCheckpoints  */ , 
    &WdgMCheckPoint[0] /*  WdgMCheckpointRef  */ , 
    WDGM_LOCAL_STATUS_OK /*  WdgMInitialStatus  */ , 
    65534u /*  WdgMFailedSupervisionRefCycleTol  */ , 
...
{
  {
    500u /*   (condition value)  WdgMTriggerTimeout  */ , 
    50u /*  WdgMTicksPerSecond[Hz]=100 , WdgMTriggerTimeoutTicks  */ , 
...
CONST(WdgM_ConfigType, WDGM_CONST) WdgMConfig_Mode0_core0 = 
{
  ...
  65535u /*  WdgMExpiredSupervisionCycleTol  */ , 
