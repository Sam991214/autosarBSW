...
) =
{
  ...
  Os_Hal_MemFault, /* OS internal HardFault (Number 3) exception handler */
  Os_Hal_MemFault, /* OS internal MemManage (Number 4) exception handler */
  Os_Hal_MemFault, /* OS internal BusFault (Number 5) exception handler */
