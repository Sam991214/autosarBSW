 ...
 * ECUM_WKSOURCE_CN_CAN_fe6ecc87 (EcuM_WakeupSourceType)(32uL) 
 */
...
/* Add implementation of EcuM_AL_DriverInitOne  */
  //virvll
//  REG_WRITE8(EEPROM_FCCOB0_ADDR32, 0x80);
//  REG_WRITE8(EEPROM_FCCOB1_ADDR32, 0x00);
//  REG_WRITE8(EEPROM_FCCOB2_ADDR32, 0x00);
//  REG_WRITE8(EEPROM_FCCOB3_ADDR32, 0x00);
//  REG_WRITE8(EEPROM_FCCOB4_ADDR32, 0x02);
//  REG_WRITE8(EEPROM_FCCOB5_ADDR32, 0x04);
//  REG_WRITE8(EEPROM_FSTAT_ADDR32, 0x80);
