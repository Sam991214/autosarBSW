...
#define PortConfigSet_PortContainer_0_PortPin_JTAG_TMS_SWD_DIO  0
/** @violates @ref PORT_CFG_H_REF_1 The used compilers use more than 31 chars for identifiers. */
#define PortConfigSet_PortContainer_0_PortPin_JTAG_TDO  1
/** @violates @ref PORT_CFG_H_REF_1 The used compilers use more than 31 chars for identifiers. */
#define PortConfigSet_PortContainer_0_PortPin_JTAG_TCLK_SWD_CLK  2
/** @violates @ref PORT_CFG_H_REF_1 The used compilers use more than 31 chars for identifiers. */
#define PortConfigSet_PortContainer_0_PortPin_JTAG_TDI  3
/** @violates @ref PORT_CFG_H_REF_1 The used compilers use more than 31 chars for identifiers. */
#define PortConfigSet_PortContainer_0_PortPin_CAN0_TX  4
/** @violates @ref PORT_CFG_H_REF_1 The used compilers use more than 31 chars for identifiers. */
#define PortConfigSet_PortContainer_0_PortPin_CAN0_RX  5
...
*/
#define PORT_MAX_UNUSED_PADS_U16   (150U)
