...
*/
#define ADC_NUM_SC1n_REGISTER      32U

/**
* @brief          Specifies if the alias SC and Rn register supported
*/
#define ADC_USE_ALIAS_REGISTERS    (STD_ON)

#define ADC_SC1_OFFSET_ADDR32     (0x108UL)

#define ADC_Rn_OFFSET_ADDR32      (0x188UL)

#define ADC_ADCH_MASK_U32         (0x3fUL)

/**
* @brief          The mask to calculale the previous channnel index
*/
#define ADC_PRE_CHANNEL_SHIFT_MASK      5U
/**
* @brief          Number of SC1n registers used
*/
#define ADC_NUM_SC1n_REGISTER_USED 32U
/**
