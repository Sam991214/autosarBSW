 ...
 *  FILE DESCRIPTION
 *  -------------------------------------------------------------------------------------------------------------------
 *          File:  Rte_WdgM_OsApplication_Trusted_Core0_Type.h
 ...
 *       License:  CBD1800257
 *
 *   Description:  Application types header file for SW-C <WdgM_OsApplication_Trusted_Core0>
 *********************************************************************************************************************/

/* double include prevention */
#ifndef _RTE_WDGM_OSAPPLICATION_TRUSTED_CORE0_TYPE_H
# define _RTE_WDGM_OSAPPLICATION_TRUSTED_CORE0_TYPE_H
...
#endif /* _RTE_WDGM_OSAPPLICATION_TRUSTED_CORE0_TYPE_H */
