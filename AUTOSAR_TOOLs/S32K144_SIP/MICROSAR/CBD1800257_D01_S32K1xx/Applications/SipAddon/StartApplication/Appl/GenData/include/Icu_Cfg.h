...
*/
#define ICU_NUM_FTM_HW_MODULE_U8  ((uint8)8U)
/**
...
/**
*   @brief ISR's configured for FTM channels
*   @details Macros for channels used in ISR
*/
...
/**
*   @brief ISR's configured for LPIT channels
*   @details Macros for channels used in ISR
*/
...
/**
*   @brief ISR's configured for LPTMR channels
*   @details Macros for channels used in ISR
*/
