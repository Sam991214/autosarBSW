...
BSWM_LOCAL FUNC(Std_ReturnType, BSWM_CODE) BswM_ActionList_CC_AL_CN_CAN_fe6ecc87_RX_Disable(void);
BSWM_LOCAL FUNC(Std_ReturnType, BSWM_CODE) BswM_ActionList_CC_AL_CN_CAN_fe6ecc87_RX_EnableNoinit(void);
BSWM_LOCAL FUNC(Std_ReturnType, BSWM_CODE) BswM_ActionList_CC_AL_CN_CAN_fe6ecc87_Disable_DM(void);
BSWM_LOCAL FUNC(Std_ReturnType, BSWM_CODE) BswM_ActionList_CC_AL_CN_CAN_fe6ecc87_Enable_DM(void);
BSWM_LOCAL FUNC(Std_ReturnType, BSWM_CODE) BswM_ActionList_CC_AL_CN_CAN_fe6ecc87_TX_Disable(void);
BSWM_LOCAL FUNC(Std_ReturnType, BSWM_CODE) BswM_ActionList_CC_AL_CN_CAN_fe6ecc87_TX_EnableNoinit(void);
...
BSWM_LOCAL FUNC(BswM_HandleType, BSWM_CODE) BswM_Rule_CC_CN_CAN_fe6ecc87_RX(void);
BSWM_LOCAL FUNC(BswM_HandleType, BSWM_CODE) BswM_Rule_CC_CN_CAN_fe6ecc87_RX_DM(void);
BSWM_LOCAL FUNC(BswM_HandleType, BSWM_CODE) BswM_Rule_CC_CN_CAN_fe6ecc87_TX(void);
...
CONST(BswM_ActionListsType, BSWM_CONST) BswM_ActionLists[20] = {
  ...
  { /*     5 */ BswM_ActionList_ESH_AL_DemInit                        },  /* [Priority: 0] */  /* [AL_ESH_AL_DemInit] */
  ...
  { /*    13 */ BswM_ActionList_CC_AL_CN_CAN_fe6ecc87_RX_Disable      },  /* [Priority: 0] */  /* [AL_CC_AL_CN_CAN_fe6ecc87_RX_Disable] */
  { /*    14 */ BswM_ActionList_CC_AL_CN_CAN_fe6ecc87_RX_EnableNoinit },  /* [Priority: 0] */  /* [AL_CC_AL_CN_CAN_fe6ecc87_RX_EnableNoinit] */
  { /*    15 */ BswM_ActionList_CC_AL_CN_CAN_fe6ecc87_Disable_DM      },  /* [Priority: 0] */  /* [AL_CC_AL_CN_CAN_fe6ecc87_Disable_DM] */
  { /*    16 */ BswM_ActionList_CC_AL_CN_CAN_fe6ecc87_Enable_DM       },  /* [Priority: 0] */  /* [AL_CC_AL_CN_CAN_fe6ecc87_Enable_DM] */
  { /*    17 */ BswM_ActionList_CC_AL_CN_CAN_fe6ecc87_TX_Disable      },  /* [Priority: 0] */  /* [AL_CC_AL_CN_CAN_fe6ecc87_TX_Disable] */
  { /*    18 */ BswM_ActionList_CC_AL_CN_CAN_fe6ecc87_TX_EnableNoinit },  /* [Priority: 0] */  /* [AL_CC_AL_CN_CAN_fe6ecc87_TX_EnableNoinit] */
  { /*    19 */ BswM_ActionList_ESH_AL_ExitRun                        }   /* [Priority: 0] */  /* [AL_ESH_AL_ExitRun] */
};
...
CONST(BswM_ImmediateUserType, BSWM_CONST) BswM_ImmediateUser[3] = {
  ...
  { /*     0 */      0x01u,                                    3u,                                      0u },  /* [Name: CC_CanSMIndication_CN_CAN_fe6ecc87] */  /* [MRP_CC_CanSMIndication_CN_CAN_fe6ecc87, CANSM_CHANNEL_0] */
...
CONST(BswM_RulesType, BSWM_CONST) BswM_Rules[15] = {
  ...
  { /*     0 */  9u, BswM_Rule_ESH_RunToPostRun         },  /* [R_ESH_RunToPostRun, MRP_ESH_State, MRP_ESH_ModeNotification, MRP_ESH_ComMIndication_CN_CAN_fe6ecc87, MRP_ESH_RunRequest_0, MRP_ESH_RunRequest_1, MRP_ESH_SelfRunRequestTimer, NoPartitions] */
  { /*     1 */ 11u, BswM_Rule_ESH_WaitToShutdown       },  /* [R_ESH_WaitToShutdown, MRP_ESH_EcuM_GetValidatedWakeupEvents, MRP_ESH_ComMPendingRequests, MRP_ESH_State, MRP_ESH_NvMIndication, MRP_ESH_NvM_WriteAllTimer, NoPartitions] */
  { /*     2 */ 13u, BswM_Rule_ESH_WakeupToPrep         },  /* [R_ESH_WakeupToPrep, MRP_ESH_State, MRP_ESH_NvMIndication, MRP_ESH_NvM_CancelWriteAllTimer, MRP_ESH_EcuM_GetPendingWakeupEvents, MRP_ESH_EcuM_GetValidatedWakeupEvents, MRP_ESH_ComMPendingRequests, MRP_ESH_ModeNotification, NoPartitions] */
  { /*     3 */ 12u, BswM_Rule_ESH_WaitToWakeup         },  /* [R_ESH_WaitToWakeup, MRP_ESH_State, MRP_ESH_EcuM_GetValidatedWakeupEvents, MRP_ESH_ComMPendingRequests, NoPartitions] */
  { /*     4 */ 14u, BswM_Rule_ESH_WakeupToRun          },  /* [R_ESH_WakeupToRun, MRP_ESH_State, MRP_ESH_EcuM_GetValidatedWakeupEvents, MRP_ESH_ComMPendingRequests, MRP_ESH_NvMIndication, MRP_ESH_NvM_CancelWriteAllTimer, MRP_ESH_ModeNotification, NoPartitions] */
  { /*     5 */  3u, BswM_Rule_ESH_DemInit              },  /* [R_ESH_DemInit, NoPartitions] */
  { /*     6 */  4u, BswM_Rule_ESH_InitToWakeup         },  /* [R_ESH_InitToWakeup, MRP_ESH_State, NoPartitions] */
  { /*     7 */  7u, BswM_Rule_ESH_PostRunToPrepNested  },  /* [R_ESH_PostRunToPrepNested, NoPartitions] */
  { /*     8 */  6u, BswM_Rule_ESH_PostRunNested        },  /* [R_ESH_PostRunNested, NoPartitions] */
  { /*     9 */  5u, BswM_Rule_ESH_PostRun              },  /* [R_ESH_PostRun, MRP_ESH_State, MRP_ESH_ModeNotification, NoPartitions] */
  { /*    10 */  8u, BswM_Rule_ESH_PrepToWait           },  /* [R_ESH_PrepToWait, MRP_ESH_State, MRP_ESH_ModeNotification, NoPartitions] */
  { /*    11 */  0u, BswM_Rule_CC_CN_CAN_fe6ecc87_RX    },  /* [R_CC_CN_CAN_fe6ecc87_RX, MRP_CC_CanSMIndication_CN_CAN_fe6ecc87, NoPartitions] */
  { /*    12 */  1u, BswM_Rule_CC_CN_CAN_fe6ecc87_RX_DM },  /* [R_CC_CN_CAN_fe6ecc87_RX_DM, MRP_CC_CanSMIndication_CN_CAN_fe6ecc87, NoPartitions] */
  { /*    13 */  2u, BswM_Rule_CC_CN_CAN_fe6ecc87_TX    },  /* [R_CC_CN_CAN_fe6ecc87_TX, MRP_CC_CanSMIndication_CN_CAN_fe6ecc87, NoPartitions] */
  { /*    14 */ 10u, BswM_Rule_ESH_RunToPostRunNested   }   /* [R_ESH_RunToPostRunNested, NoPartitions] */
};
#define BSWM_STOP_SEC_CONST_UNSPECIFIED
/*lint -save -esym(961, 19.1) */
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_19.1 */
...
CONST(BswM_RulesIndType, BSWM_CONST) BswM_RulesInd[11] = {
  ...
  /*     0 */      11u,  /* [MRP_CC_CanSMIndication_CN_CAN_fe6ecc87] */
  /*     1 */      12u,  /* [MRP_CC_CanSMIndication_CN_CAN_fe6ecc87] */
  /*     2 */      13u,  /* [MRP_CC_CanSMIndication_CN_CAN_fe6ecc87] */
  /*     3 */       0u,  /* [MRP_ESH_State] */
  /*     4 */       1u,  /* [MRP_ESH_State] */
  /*     5 */       2u,  /* [MRP_ESH_State] */
  /*     6 */       3u,  /* [MRP_ESH_State] */
...
VAR(uBswM_ActionListQueueType, BSWM_VAR_NOINIT) BswM_ActionListQueue;  /* PRQA S 0759 */  /* MD_CSL_18.4 */
  ...
  /*    13 */  /* [AL_CC_AL_CN_CAN_fe6ecc87_RX_Disable] */
  /*    14 */  /* [AL_CC_AL_CN_CAN_fe6ecc87_RX_EnableNoinit] */
  /*    15 */  /* [AL_CC_AL_CN_CAN_fe6ecc87_Disable_DM] */
  /*    16 */  /* [AL_CC_AL_CN_CAN_fe6ecc87_Enable_DM] */
  /*    17 */  /* [AL_CC_AL_CN_CAN_fe6ecc87_TX_Disable] */
  /*    18 */  /* [AL_CC_AL_CN_CAN_fe6ecc87_TX_EnableNoinit] */
  /*    19 */  /* [AL_ESH_AL_ExitRun] */
...
VAR(CanSM_BswMCurrentStateType, BSWM_VAR_NOINIT) BswM_CanSMChannelState[1];
  /* Index        Referable Keys  */
  /*     0 */  /* [CANSM_CHANNEL_0, MRP_CC_CanSMIndication_CN_CAN_fe6ecc87] */
...
VAR(ComM_ModeType, BSWM_VAR_NOINIT) BswM_ComMChannelState[1];
  /* Index        Referable Keys  */
  /*     0 */  /* [COMM_CHANNEL_0, MRP_ESH_ComMIndication_CN_CAN_fe6ecc87] */
...
VAR(BswM_ModeRequestQueueType, BSWM_VAR_NOINIT) BswM_ModeRequestQueue[3];
  /* Index        Referable Keys  */
  /*     0 */  /* [MRP_CC_CanSMIndication_CN_CAN_fe6ecc87, CANSM_CHANNEL_0] */
...
VAR(BswM_RuleStatesType, BSWM_VAR_NOINIT) BswM_RuleStates[15];
  /* Index        Referable Keys  */
  /*     0 */  /* [R_ESH_RunToPostRun, MRP_ESH_State, MRP_ESH_ModeNotification, MRP_ESH_ComMIndication_CN_CAN_fe6ecc87, MRP_ESH_RunRequest_0, MRP_ESH_RunRequest_1, MRP_ESH_SelfRunRequestTimer, NoPartitions] */
  /*     1 */  /* [R_ESH_WaitToShutdown, MRP_ESH_EcuM_GetValidatedWakeupEvents, MRP_ESH_ComMPendingRequests, MRP_ESH_State, MRP_ESH_NvMIndication, MRP_ESH_NvM_WriteAllTimer, NoPartitions] */
  /*     2 */  /* [R_ESH_WakeupToPrep, MRP_ESH_State, MRP_ESH_NvMIndication, MRP_ESH_NvM_CancelWriteAllTimer, MRP_ESH_EcuM_GetPendingWakeupEvents, MRP_ESH_EcuM_GetValidatedWakeupEvents, MRP_ESH_ComMPendingRequests, MRP_ESH_ModeNotification, NoPartitions] */
  /*     3 */  /* [R_ESH_WaitToWakeup, MRP_ESH_State, MRP_ESH_EcuM_GetValidatedWakeupEvents, MRP_ESH_ComMPendingRequests, NoPartitions] */
  /*     4 */  /* [R_ESH_WakeupToRun, MRP_ESH_State, MRP_ESH_EcuM_GetValidatedWakeupEvents, MRP_ESH_ComMPendingRequests, MRP_ESH_NvMIndication, MRP_ESH_NvM_CancelWriteAllTimer, MRP_ESH_ModeNotification, NoPartitions] */
  /*     5 */  /* [R_ESH_DemInit, NoPartitions] */
  ...
  /*    11 */  /* [R_CC_CN_CAN_fe6ecc87_RX, MRP_CC_CanSMIndication_CN_CAN_fe6ecc87, NoPartitions] */
  /*    12 */  /* [R_CC_CN_CAN_fe6ecc87_RX_DM, MRP_CC_CanSMIndication_CN_CAN_fe6ecc87, NoPartitions] */
  /*    13 */  /* [R_CC_CN_CAN_fe6ecc87_TX, MRP_CC_CanSMIndication_CN_CAN_fe6ecc87, NoPartitions] */
  /*    14 */  /* [R_ESH_RunToPostRunNested, NoPartitions] */
...
BSWM_LOCAL FUNC(Std_ReturnType, BSWM_CODE) BswM_ActionList_ESH_AL_RunToPostRun(void)
{
  ComM_CommunicationAllowed(ComMConf_ComMChannel_CN_CAN_fe6ecc87, FALSE);
...
BSWM_LOCAL FUNC(Std_ReturnType, BSWM_CODE) BswM_ActionList_ESH_AL_WakeupToRun(void)
{
  ...
  ComM_CommunicationAllowed(ComMConf_ComMChannel_CN_CAN_fe6ecc87, TRUE);
...
/**********************************************************************************************************************
 *  BswM_ActionList_CC_AL_CN_CAN_fe6ecc87_RX_Disable
 *********************************************************************************************************************/
BSWM_LOCAL FUNC(Std_ReturnType, BSWM_CODE) BswM_ActionList_CC_AL_CN_CAN_fe6ecc87_RX_Disable(void)
{
  /* PRQA S 0277, 3109, 3201, 3325 COMSETIPDU */ /* MD_BswM_0277, MD_BswM_3109, MD_BswM_3201, MD_BswM_3325 */ /*lint -e506 -e572 */
  BswM_SetIpduGroup(ComConf_ComIPduGroup_MyECU_oCAN_Rx_63a3e3ce, FALSE); /* SBSW_BSWM_IPDUGROUPVECTORCALL */
  /* PRQA L:COMSETIPDU */ /*lint +e506 +e572 */
  /* PRQA S 0277, 3109, 3201, 3325 COMSETIPDU */ /* MD_BswM_0277, MD_BswM_3109, MD_BswM_3201, MD_BswM_3325 */ /*lint -e506 -e572 */
  BswM_SetIpduDMGroup(ComConf_ComIPduGroup_MyECU_oCAN_Rx_63a3e3ce, FALSE); /* SBSW_BSWM_IPDUGROUPVECTORCALL */
  /* PRQA L:COMSETIPDU */ /*lint +e506 +e572 */
...
/**********************************************************************************************************************
 *  BswM_ActionList_CC_AL_CN_CAN_fe6ecc87_RX_EnableNoinit
 *********************************************************************************************************************/
BSWM_LOCAL FUNC(Std_ReturnType, BSWM_CODE) BswM_ActionList_CC_AL_CN_CAN_fe6ecc87_RX_EnableNoinit(void)
{
  /* PRQA S 0277, 3109, 3201, 3325 COMSETIPDU */ /* MD_BswM_0277, MD_BswM_3109, MD_BswM_3201, MD_BswM_3325 */ /*lint -e506 -e572 */
  BswM_SetIpduGroup(ComConf_ComIPduGroup_MyECU_oCAN_Rx_63a3e3ce, TRUE); /* SBSW_BSWM_IPDUGROUPVECTORCALL */
  /* PRQA L:COMSETIPDU */ /*lint +e506 +e572 */
  /* PRQA S 0277, 3109, 3201, 3325 COMSETIPDU */ /* MD_BswM_0277, MD_BswM_3109, MD_BswM_3201, MD_BswM_3325 */ /*lint -e506 -e572 */
  BswM_SetIpduDMGroup(ComConf_ComIPduGroup_MyECU_oCAN_Rx_63a3e3ce, TRUE); /* SBSW_BSWM_IPDUGROUPVECTORCALL */
  /* PRQA L:COMSETIPDU */ /*lint +e506 +e572 */
  BswM_MarkPduGroupControlInvocation(BSWM_GROUPCONTROL_NORMAL);
  return E_OK;
}/* PRQA S 6010, 6030, 6050 */ /* MD_MSR_STPTH, MD_MSR_STCYC, MD_MSR_STCAL */
...
/**********************************************************************************************************************
 *  BswM_ActionList_CC_AL_CN_CAN_fe6ecc87_Disable_DM
 *********************************************************************************************************************/
BSWM_LOCAL FUNC(Std_ReturnType, BSWM_CODE) BswM_ActionList_CC_AL_CN_CAN_fe6ecc87_Disable_DM(void)
{
  /* PRQA S 0277, 3109, 3201, 3325 COMSETIPDU */ /* MD_BswM_0277, MD_BswM_3109, MD_BswM_3201, MD_BswM_3325 */ /*lint -e506 -e572 */
...
/**********************************************************************************************************************
 *  BswM_ActionList_CC_AL_CN_CAN_fe6ecc87_Enable_DM
 *********************************************************************************************************************/
BSWM_LOCAL FUNC(Std_ReturnType, BSWM_CODE) BswM_ActionList_CC_AL_CN_CAN_fe6ecc87_Enable_DM(void)
{
  /* PRQA S 0277, 3109, 3201, 3325 COMSETIPDU */ /* MD_BswM_0277, MD_BswM_3109, MD_BswM_3201, MD_BswM_3325 */ /*lint -e506 -e572 */
...
/**********************************************************************************************************************
 *  BswM_ActionList_CC_AL_CN_CAN_fe6ecc87_TX_Disable
 *********************************************************************************************************************/
BSWM_LOCAL FUNC(Std_ReturnType, BSWM_CODE) BswM_ActionList_CC_AL_CN_CAN_fe6ecc87_TX_Disable(void)
{
  /* PRQA S 0277, 3109, 3201, 3325 COMSETIPDU */ /* MD_BswM_0277, MD_BswM_3109, MD_BswM_3201, MD_BswM_3325 */ /*lint -e506 -e572 */
  BswM_SetIpduGroup(ComConf_ComIPduGroup_MyECU_oCAN_Tx_35f94448, FALSE); /* SBSW_BSWM_IPDUGROUPVECTORCALL */
  /* PRQA L:COMSETIPDU */ /*lint +e506 +e572 */
  /* PRQA S 0277, 3109, 3201, 3325 COMSETIPDU */ /* MD_BswM_0277, MD_BswM_3109, MD_BswM_3201, MD_BswM_3325 */ /*lint -e506 -e572 */
  BswM_SetIpduDMGroup(ComConf_ComIPduGroup_MyECU_oCAN_Tx_35f94448, FALSE); /* SBSW_BSWM_IPDUGROUPVECTORCALL */
  /* PRQA L:COMSETIPDU */ /*lint +e506 +e572 */
  BswM_MarkPduGroupControlInvocation(BSWM_GROUPCONTROL_NORMAL);
  return E_OK;
}/* PRQA S 6010, 6030, 6050 */ /* MD_MSR_STPTH, MD_MSR_STCYC, MD_MSR_STCAL */
...
/**********************************************************************************************************************
 *  BswM_ActionList_CC_AL_CN_CAN_fe6ecc87_TX_EnableNoinit
 *********************************************************************************************************************/
BSWM_LOCAL FUNC(Std_ReturnType, BSWM_CODE) BswM_ActionList_CC_AL_CN_CAN_fe6ecc87_TX_EnableNoinit(void)
{
  /* PRQA S 0277, 3109, 3201, 3325 COMSETIPDU */ /* MD_BswM_0277, MD_BswM_3109, MD_BswM_3201, MD_BswM_3325 */ /*lint -e506 -e572 */
  BswM_SetIpduGroup(ComConf_ComIPduGroup_MyECU_oCAN_Tx_35f94448, TRUE); /* SBSW_BSWM_IPDUGROUPVECTORCALL */
  /* PRQA L:COMSETIPDU */ /*lint +e506 +e572 */
  /* PRQA S 0277, 3109, 3201, 3325 COMSETIPDU */ /* MD_BswM_0277, MD_BswM_3109, MD_BswM_3201, MD_BswM_3325 */ /*lint -e506 -e572 */
  BswM_SetIpduDMGroup(ComConf_ComIPduGroup_MyECU_oCAN_Tx_35f94448, TRUE); /* SBSW_BSWM_IPDUGROUPVECTORCALL */
  /* PRQA L:COMSETIPDU */ /*lint +e506 +e572 */
  BswM_MarkPduGroupControlInvocation(BSWM_GROUPCONTROL_NORMAL);
  return E_OK;
}/* PRQA S 6010, 6030, 6050 */ /* MD_MSR_STPTH, MD_MSR_STCYC, MD_MSR_STCAL */
...
BSWM_LOCAL FUNC(BswM_HandleType, BSWM_CODE) BswM_Rule_ESH_WaitToShutdown(void)
{
  ...
  if(((EcuM_GetValidatedWakeupEvents() == 0u) && (BswM_GetGenericState(2) == BSWM_GENERICVALUE_ESH_ComMPendingRequests_ESH_COMM_NO_REQUEST)) && (BswM_GetGenericState(0) == BSWM_GENERICVALUE_ESH_State_ESH_WAIT_FOR_NVM) && ((BswM_GetNvMJobState(0) != NVM_REQ_PENDING) || (BswM_GetTimerState(1) != BSWM_TIMER_STARTED)))
  {
...
/**********************************************************************************************************************
 *  BswM_Rule_CC_CN_CAN_fe6ecc87_RX
 *********************************************************************************************************************/
BSWM_LOCAL FUNC(BswM_HandleType, BSWM_CODE) BswM_Rule_CC_CN_CAN_fe6ecc87_RX(void)
{
  BswM_HandleType retVal = BSWM_NO_ACTIONLIST;
  /* Evaluate logical expression CC_LE_CN_CAN_fe6ecc87_RX. */
  if(BswM_GetCanSMChannelState(0) != CANSM_BSWM_NO_COMMUNICATION)
  {
    if( BswM_GetRuleStates(BSWM_ID_RULE_CC_CN_CAN_fe6ecc87_RX) != BSWM_TRUE ) /* COV_BSWM_TRIGGEREDRULEEXECUTION */
    {
      BswM_UpdateRuleStates(BSWM_ID_RULE_CC_CN_CAN_fe6ecc87_RX, BSWM_TRUE);
      /* Return triggered action list BswM_ActionList_CC_AL_CN_CAN_fe6ecc87_RX_EnableNoinit. */
      retVal = BSWM_ID_AL_CC_AL_CN_CAN_fe6ecc87_RX_EnableNoinit;
    }
  }
  else
  {
    if( BswM_GetRuleStates(BSWM_ID_RULE_CC_CN_CAN_fe6ecc87_RX) != BSWM_FALSE ) /* COV_BSWM_TRIGGEREDRULEEXECUTION */
    {
      BswM_UpdateRuleStates(BSWM_ID_RULE_CC_CN_CAN_fe6ecc87_RX, BSWM_FALSE);
      /* Return triggered action list BswM_ActionList_CC_AL_CN_CAN_fe6ecc87_RX_Disable. */
      retVal = BSWM_ID_AL_CC_AL_CN_CAN_fe6ecc87_RX_Disable;
    }
  }
  return retVal;
}
...
/**********************************************************************************************************************
 *  BswM_Rule_CC_CN_CAN_fe6ecc87_RX_DM
 *********************************************************************************************************************/
BSWM_LOCAL FUNC(BswM_HandleType, BSWM_CODE) BswM_Rule_CC_CN_CAN_fe6ecc87_RX_DM(void)
{
  BswM_HandleType retVal = BSWM_NO_ACTIONLIST;
  /* Evaluate logical expression CC_LE_CN_CAN_fe6ecc87_RX_DM. */
  if(BswM_GetCanSMChannelState(0) == CANSM_BSWM_FULL_COMMUNICATION)
  {
    if( BswM_GetRuleStates(BSWM_ID_RULE_CC_CN_CAN_fe6ecc87_RX_DM) != BSWM_TRUE ) /* COV_BSWM_TRIGGEREDRULEEXECUTION */
    {
      BswM_UpdateRuleStates(BSWM_ID_RULE_CC_CN_CAN_fe6ecc87_RX_DM, BSWM_TRUE);
      /* Return triggered action list BswM_ActionList_CC_AL_CN_CAN_fe6ecc87_Enable_DM. */
      retVal = BSWM_ID_AL_CC_AL_CN_CAN_fe6ecc87_Enable_DM;
    }
  }
  else
  {
    if( BswM_GetRuleStates(BSWM_ID_RULE_CC_CN_CAN_fe6ecc87_RX_DM) != BSWM_FALSE ) /* COV_BSWM_TRIGGEREDRULEEXECUTION */
    {
      BswM_UpdateRuleStates(BSWM_ID_RULE_CC_CN_CAN_fe6ecc87_RX_DM, BSWM_FALSE);
      /* Return triggered action list BswM_ActionList_CC_AL_CN_CAN_fe6ecc87_Disable_DM. */
      retVal = BSWM_ID_AL_CC_AL_CN_CAN_fe6ecc87_Disable_DM;
    }
  }
  return retVal;
}
...
/**********************************************************************************************************************
 *  BswM_Rule_CC_CN_CAN_fe6ecc87_TX
 *********************************************************************************************************************/
BSWM_LOCAL FUNC(BswM_HandleType, BSWM_CODE) BswM_Rule_CC_CN_CAN_fe6ecc87_TX(void)
{
  BswM_HandleType retVal = BSWM_NO_ACTIONLIST;
  /* Evaluate logical expression CC_LE_CN_CAN_fe6ecc87_TX. */
  if(BswM_GetCanSMChannelState(0) == CANSM_BSWM_FULL_COMMUNICATION)
  {
    if( BswM_GetRuleStates(BSWM_ID_RULE_CC_CN_CAN_fe6ecc87_TX) != BSWM_TRUE ) /* COV_BSWM_TRIGGEREDRULEEXECUTION */
    {
      BswM_UpdateRuleStates(BSWM_ID_RULE_CC_CN_CAN_fe6ecc87_TX, BSWM_TRUE);
      /* Return triggered action list BswM_ActionList_CC_AL_CN_CAN_fe6ecc87_TX_EnableNoinit. */
      retVal = BSWM_ID_AL_CC_AL_CN_CAN_fe6ecc87_TX_EnableNoinit;
    }
  }
  else
  {
    if( BswM_GetRuleStates(BSWM_ID_RULE_CC_CN_CAN_fe6ecc87_TX) != BSWM_FALSE ) /* COV_BSWM_TRIGGEREDRULEEXECUTION */
    {
      BswM_UpdateRuleStates(BSWM_ID_RULE_CC_CN_CAN_fe6ecc87_TX, BSWM_FALSE);
      /* Return triggered action list BswM_ActionList_CC_AL_CN_CAN_fe6ecc87_TX_Disable. */
      retVal = BSWM_ID_AL_CC_AL_CN_CAN_fe6ecc87_TX_Disable;
    }
  }
  return retVal;
}
