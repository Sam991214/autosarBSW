...
/*! Dynamic application data: OsApplication_NonTrusted_Core0 */
OS_LOCAL VAR(Os_AppType, OS_VAR_NOINIT) OsCfg_App_OsApplication_NonTrusted_Core0_Dyn;
...
/*! Object reference table for application alarms: OsApplication_NonTrusted_Core0 */
OS_LOCAL CONST(Os_AlarmConfigRefType, OS_CONST) OsCfg_App_OsApplication_NonTrusted_Core0_AlarmRefs[OS_CFG_NUM_APP_OSAPPLICATION_NONTRUSTED_CORE0_ALARMS + 1] =
{
...
/*! Object reference table for application counters: OsApplication_NonTrusted_Core0 */
OS_LOCAL CONST(Os_CounterConfigRefType, OS_CONST) OsCfg_App_OsApplication_NonTrusted_Core0_CounterRefs[OS_CFG_NUM_APP_OSAPPLICATION_NONTRUSTED_CORE0_COUNTERS + 1] =
{
  NULL_PTR
};

/*! Object reference table for application hooks: OsApplication_NonTrusted_Core0 */
OS_LOCAL CONST(Os_HookConfigRefType, OS_CONST) OsCfg_App_OsApplication_NonTrusted_Core0_HookRefs[OS_CFG_NUM_APP_OSAPPLICATION_NONTRUSTED_CORE0_HOOKS + 1] =
{
  NULL_PTR
};

/*! Object reference table for application ISRs: OsApplication_NonTrusted_Core0 */
OS_LOCAL CONST(Os_IsrConfigRefType, OS_CONST) OsCfg_App_OsApplication_NonTrusted_Core0_IsrRefs[OS_CFG_NUM_APP_OSAPPLICATION_NONTRUSTED_CORE0_ISRS + 1] =
{
...
/*! Object reference table for application category 1 (EXTERNAL) ISRs: OsApplication_NonTrusted_Core0 */
OS_LOCAL CONST(Os_IsrCat1ConfigRefType, OS_CONST) OsCfg_App_OsApplication_NonTrusted_Core0_Cat1IsrRefs[OS_CFG_NUM_APP_OSAPPLICATION_NONTRUSTED_CORE0_CAT1ISRS + 1] =
{
  NULL_PTR
};

/*! Object reference table for application schedule tables: OsApplication_NonTrusted_Core0 */
OS_LOCAL CONST(Os_SchTConfigRefType, OS_CONST) OsCfg_App_OsApplication_NonTrusted_Core0_SchTRefs[OS_CFG_NUM_APP_OSAPPLICATION_NONTRUSTED_CORE0_SCHTS + 1] =
{
  NULL_PTR
};

/*! Object reference table for application tasks: OsApplication_NonTrusted_Core0 */
OS_LOCAL CONST(Os_TaskConfigRefType, OS_CONST) OsCfg_App_OsApplication_NonTrusted_Core0_TaskRefs[OS_CFG_NUM_APP_OSAPPLICATION_NONTRUSTED_CORE0_TASKS + 1] =
{
...
/*! Object reference table for application trusted functions: OsApplication_NonTrusted_Core0 */
OS_LOCAL CONST(Os_ServiceConfigRefType, OS_CONST) OsCfg_App_OsApplication_NonTrusted_Core0_ServiceRefs[OS_CFG_NUM_APP_OSAPPLICATION_NONTRUSTED_CORE0_SERVICES + 1] =
{
  NULL_PTR
};

/*! Application configuration data: OsApplication_NonTrusted_Core0 */
CONST(Os_AppConfigType, OS_CONST) OsCfg_App_OsApplication_NonTrusted_Core0 =
{
  /* .Dyn                  = */ &OsCfg_App_OsApplication_NonTrusted_Core0_Dyn,
  /* .Core                 = */ &OsCfg_Core_OsCore0,
  /* .AccessRightId        = */ OS_APPID2MASK(OsApplication_NonTrusted_Core0),
  /* .TaskRefs             = */ OsCfg_App_OsApplication_NonTrusted_Core0_TaskRefs,
  /* .TaskCount            = */ OS_CFG_NUM_APP_OSAPPLICATION_NONTRUSTED_CORE0_TASKS,
  /* .IsrCat2Refs          = */ OsCfg_App_OsApplication_NonTrusted_Core0_IsrRefs,
  /* .IsrCat2Count         = */ OS_CFG_NUM_APP_OSAPPLICATION_NONTRUSTED_CORE0_ISRS,
  /* .IsrCat1Refs          = */ OsCfg_App_OsApplication_NonTrusted_Core0_Cat1IsrRefs,
  /* .IsrCat1Count         = */ OS_CFG_NUM_APP_OSAPPLICATION_NONTRUSTED_CORE0_CAT1ISRS,
  /* .CounterRefs          = */ OsCfg_App_OsApplication_NonTrusted_Core0_CounterRefs,
  /* .CounterCount         = */ OS_CFG_NUM_APP_OSAPPLICATION_NONTRUSTED_CORE0_COUNTERS,
  /* .AlarmRefs            = */ OsCfg_App_OsApplication_NonTrusted_Core0_AlarmRefs,
  /* .AlarmCount           = */ OS_CFG_NUM_APP_OSAPPLICATION_NONTRUSTED_CORE0_ALARMS,
  /* .SchTRefs             = */ OsCfg_App_OsApplication_NonTrusted_Core0_SchTRefs,
  /* .SchTCount            = */ OS_CFG_NUM_APP_OSAPPLICATION_NONTRUSTED_CORE0_SCHTS,
  /* .ServiceFunctions     = */ OsCfg_App_OsApplication_NonTrusted_Core0_ServiceRefs,
  /* .ServiceFunctionCount = */ OS_CFG_NUM_APP_OSAPPLICATION_NONTRUSTED_CORE0_SERVICES,
  ...
  /* .HookCount            = */ OS_CFG_NUM_APP_OSAPPLICATION_NONTRUSTED_CORE0_HOOKS,
