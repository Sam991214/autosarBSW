...
#define EEP_SW_PATCH_VERSION_PCFG_C               0
...
/* Check if current file and Eep header file are of the same Software version */
 ...
 #if ((EEP_AR_RELEASE_MAJOR_VERSION_PCFG_C != DEM_AR_RELEASE_MAJOR_VERSION) || \
      (EEP_AR_RELEASE_MINOR_VERSION_PCFG_C != DEM_AR_RELEASE_MINOR_VERSION) \
     )
