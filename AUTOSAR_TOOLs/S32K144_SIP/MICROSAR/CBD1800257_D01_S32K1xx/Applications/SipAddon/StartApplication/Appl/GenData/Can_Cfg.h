...
#if !defined( C_COMP_GHS_S32_FLEXCAN3 )
#define C_COMP_GHS_S32_FLEXCAN3
#endif
#if !defined( V_COMP_GHS )
# define V_COMP_GHS
#endif
#if !defined( V_COMP_GHS_S32 )
# define V_COMP_GHS_S32
#endif
...
#define CanConf_CanController_CT_CAN_d43e43a4                         0
/**\} */
#define CanConf_CN_CAN_23287e84_Rx 1U
#define CanConf_CN_CAN_fe6ecc87_Tx 0U

#define CanConf_ControllerBaudrateConfig_CT_CAN_d43e43a4_CanControllerBaudrateConfig 0u
...
#define CAN_PROTECTEDAREAID                                           STD_ON
...
#define CAN_SIZEOFPROTECTEDAREAID                                     STD_ON
...
#define CAN_PROTECTEDAREAIDOFPCCONFIG                                 STD_ON
...
#define CAN_SIZEOFPROTECTEDAREAIDOFPCCONFIG                           STD_ON
...
#define CAN_ISDEF_PROTECTEDAREAID                                     STD_OFF
...
#define CAN_ISDEF_PROTECTEDAREAIDOFPCCONFIG                           STD_ON
...
#define CAN_EQ2_PROTECTEDAREAID                                       
...
#define CAN_EQ2_PROTECTEDAREAIDOFPCCONFIG                             Can_ProtectedAreaId
...
#define Can_GetProtectedAreaIdOfPCConfig()                            Can_ProtectedAreaId  /**< the pointer to Can_ProtectedAreaId */
...
#define Can_GetSizeOfProtectedAreaIdOfPCConfig()                      1u  /**< the number of accomplishable value elements in Can_ProtectedAreaId */
...
#define Can_GetProtectedAreaId(Index)                                 (Can_GetProtectedAreaIdOfPCConfig()[(Index)])
...
#define Can_GetSizeOfProtectedAreaId()                                Can_GetSizeOfProtectedAreaIdOfPCConfig()
...
#define Can_HasProtectedAreaId()                                      (TRUE != FALSE)
...
#define Can_HasSizeOfProtectedAreaId()                                (TRUE != FALSE)
...
#define Can_HasProtectedAreaIdOfPCConfig()                            (TRUE != FALSE)
...
#define Can_HasSizeOfProtectedAreaIdOfPCConfig()                      (TRUE != FALSE)
...
/**   \brief  type used to iterate Can_ProtectedAreaId */
typedef uint8_least Can_ProtectedAreaIdIterType;
...
/**   \brief  value based type definition for Can_ProtectedAreaId */
typedef uint16 Can_ProtectedAreaIdType;
...
/**   \brief  value based type definition for Can_SizeOfProtectedAreaId */
typedef uint16 Can_SizeOfProtectedAreaIdType;
...
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_19.1 */
/*lint -restore */
extern CONST(Can_ProtectedAreaIdType, CAN_CONST) Can_ProtectedAreaId[1];
#define CAN_STOP_SEC_CONST_16BIT
/*lint -save -esym(961, 19.1) */
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_19.1 */
/*lint -restore */
