...
CONST(Nm_ChannelConfigType, NM_CONST) Nm_ChannelConfig[1] = {
  ...
  { /*     0 */ ComMConf_ComMChannel_CN_CAN_fe6ecc87,                 0u, NULL_PTR        }   /* [/ActiveEcuC/ComM/ComMConfigSet/CN_CAN_fe6ecc87] */
};
#define NM_STOP_SEC_CONST_UNSPECIFIED
/*lint -save -esym(961, 19.1) */
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_19.1 */
...
CONST(Nm_NmFunctionTableType, NM_CONST) Nm_NmFunctionTable[1] = {
    /* Index    CheckRemoteSleepIndication         GetLocalNodeIdentifier         GetNodeIdentifier         GetPduData         GetUserData         GetState         NetworkRelease         NetworkRequest         PassiveStartUp               Referable Keys */
  { /*     0 */ NmOsek_CheckRemoteSleepIndication, NmOsek_GetLocalNodeIdentifier, NmOsek_GetNodeIdentifier, NmOsek_GetPduData, NmOsek_GetUserData, NmOsek_GetState, NmOsek_NetworkRelease, NmOsek_NetworkRequest, NmOsek_PassiveStartUp }   /* [NmOsek] */
};
#define NM_STOP_SEC_CONST_UNSPECIFIED
/*lint -save -esym(961, 19.1) */
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_19.1 */
