...
extern FUNC(void, CANSM_APPL_CODE) NmOsek_CanSM_BusOffBegin( NetworkHandleType  NetworkHandle, P2VAR(uint8, AUTOMATIC, CANSM_APPL_VAR) OnlineDelayCyclesPtr );
...
extern FUNC(void, CANSM_APPL_CODE) NmOsek_CanSM_BusOffEnd( NetworkHandleType  NetworkHandle );
