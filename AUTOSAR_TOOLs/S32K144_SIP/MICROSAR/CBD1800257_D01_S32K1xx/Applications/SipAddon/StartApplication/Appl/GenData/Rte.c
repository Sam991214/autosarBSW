...
FUNC(void, RTE_CODE) SchM_Init(void)
{
  ...
  (void)SetRelAlarm(Rte_Al_TE2_OsTask_WdgM_Cyclic_0_10ms, RTE_MSEC_SystemTimer(0) + (TickType)1, RTE_MSEC_SystemTimer(10)); /* PRQA S 3417 */ /* MD_Rte_Os */
  ...
  (void)SetRelAlarm(Rte_Al_TE2_Default_BSW_Async_Task_0_1ms, RTE_MSEC_SystemTimer(0) + (TickType)1, RTE_MSEC_SystemTimer(1)); /* PRQA S 3417 */ /* MD_Rte_Os */
...
FUNC(void, RTE_CODE) SchM_Deinit(void)
{
  ...
  (void)CancelAlarm(Rte_Al_TE2_Default_BSW_Async_Task_0_1ms); /* PRQA S 3417 */ /* MD_Rte_Os */
  ...
  (void)CancelAlarm(Rte_Al_TE2_OsTask_WdgM_Cyclic_0_10ms); /* PRQA S 3417 */ /* MD_Rte_Os */
...
FUNC(void, RTE_CODE) Rte_InitMemory(void) /* PRQA S 0850 */ /* MD_MSR_19.8 */
{
  ...
  Rte_InitMemory_OsApplication_NonTrusted_Core0();
