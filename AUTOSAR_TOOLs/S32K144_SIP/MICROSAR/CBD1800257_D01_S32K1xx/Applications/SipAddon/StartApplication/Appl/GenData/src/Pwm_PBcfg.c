...
#if (PWM_PB_CFG_VENDOR_ID_C != REG_ESYS_FTM_VENDOR_ID)
...
#if ((PWM_PB_CFG_AR_RELEASE_MAJOR_VERSION_C    != REG_ESYS_FTM_AR_RELEASE_MAJOR_VERSION) || \
     (PWM_PB_CFG_AR_RELEASE_MINOR_VERSION_C    != REG_ESYS_FTM_AR_RELEASE_MINOR_VERSION) || \
     (PWM_PB_CFG_AR_RELEASE_REVISION_VERSION_C != REG_ESYS_FTM_AR_RELEASE_REVISION_VERSION))
...
#if ((PWM_PB_CFG_SW_MAJOR_VERSION_C != REG_ESYS_FTM_SW_MAJOR_VERSION) || \
     (PWM_PB_CFG_SW_MINOR_VERSION_C != REG_ESYS_FTM_SW_MINOR_VERSION) || \
     (PWM_PB_CFG_SW_PATCH_VERSION_C != REG_ESYS_FTM_SW_PATCH_VERSION))
...
#if (PWM_PB_CFG_VENDOR_ID_C != FTM_COMMON_TYPES_VENDOR_ID)
...
#if ((PWM_PB_CFG_AR_RELEASE_MAJOR_VERSION_C    != FTM_COMMON_TYPES_AR_RELEASE_MAJOR_VERSION) || \
     (PWM_PB_CFG_AR_RELEASE_MINOR_VERSION_C    != FTM_COMMON_TYPES_AR_RELEASE_MINOR_VERSION) || \
     (PWM_PB_CFG_AR_RELEASE_REVISION_VERSION_C != FTM_COMMON_TYPES_AR_RELEASE_REVISION_VERSION))
...
#if ((PWM_PB_CFG_SW_MAJOR_VERSION_C != FTM_COMMON_TYPES_SW_MAJOR_VERSION) || \
     (PWM_PB_CFG_SW_MINOR_VERSION_C != FTM_COMMON_TYPES_SW_MINOR_VERSION) || \
     (PWM_PB_CFG_SW_PATCH_VERSION_C != FTM_COMMON_TYPES_SW_PATCH_VERSION))
...
static CONST(Pwm_Ftm_ModuleConfigType, PWM_CONST) Pwm_Ftm_ModuleConfig_PB[PWM_FTM_MOD_CONFIGS_PB] =
{
    ...
    /* Ftm Module 0 */
    {
        ...
        /** @brief Default period value: , freq = 3.84E11 Hz: FTM_1_MOD register*/
        ((Pwm_PeriodType) 0)
...
CONST(Pwm_ConfigType, Pwm_CONST) PwmChannelConfigSet=
{
   /** @brief Number of configured Pwm channels */
    ...
    equal to total number of available channels on FTM IPV */
    {
        ...
        (Pwm_ChannelType)255, (Pwm_ChannelType)255, (Pwm_ChannelType)255, (Pwm_ChannelType)255, (Pwm_ChannelType)255, (Pwm_ChannelType)255, (Pwm_ChannelType)255, (Pwm_ChannelType)255,
        /* Idx of channels 0-7 of Ftm Module 6 in the array of logic Pwm channels */
        (Pwm_ChannelType)255, (Pwm_ChannelType)255, (Pwm_ChannelType)255, (Pwm_ChannelType)255, (Pwm_ChannelType)255, (Pwm_ChannelType)255, (Pwm_ChannelType)255, (Pwm_ChannelType)255,
        /* Idx of channels 0-7 of Ftm Module 7 in the array of logic Pwm channels */
        (Pwm_ChannelType)255, (Pwm_ChannelType)255, (Pwm_ChannelType)255, (Pwm_ChannelType)255, (Pwm_ChannelType)255, (Pwm_ChannelType)255, (Pwm_ChannelType)255, (Pwm_ChannelType)255
    }
