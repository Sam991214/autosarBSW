...
#define BswMConf_BswMRule_CC_CN_CAN_fe6ecc87_RX (0) 
#define BswMConf_BswMRule_CC_CN_CAN_fe6ecc87_RX_DM (1) 
#define BswMConf_BswMRule_CC_CN_CAN_fe6ecc87_TX (2) 
...
#define BSWM_EQ2_EXTERNALIDOFCANSMCHANNELMAPPING                      ComMConf_ComMChannel_CN_CAN_fe6ecc87
...
#define BSWM_EQ2_EXTERNALIDOFCOMMCHANNELMAPPING                       ComMConf_ComMChannel_CN_CAN_fe6ecc87
...
typedef struct sBswM_ActionListQueueStructTag
{
  ...
  BswM_ActionListQueueType AL_CC_AL_CN_CAN_fe6ecc87_RX_Disable[1];
  BswM_ActionListQueueType AL_CC_AL_CN_CAN_fe6ecc87_RX_EnableNoinit[1];
  BswM_ActionListQueueType AL_CC_AL_CN_CAN_fe6ecc87_Disable_DM[1];
  BswM_ActionListQueueType AL_CC_AL_CN_CAN_fe6ecc87_Enable_DM[1];
  BswM_ActionListQueueType AL_CC_AL_CN_CAN_fe6ecc87_TX_Disable[1];
  BswM_ActionListQueueType AL_CC_AL_CN_CAN_fe6ecc87_TX_EnableNoinit[1];
