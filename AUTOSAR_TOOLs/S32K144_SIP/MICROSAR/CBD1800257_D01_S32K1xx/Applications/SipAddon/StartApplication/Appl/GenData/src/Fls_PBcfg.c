...
static CONST(uint8, FLS_CONST) FlsConfigSet_aFlsSectorFlags[6] =
{
    0U, /* (FlsSector_0) */
    0U, /* (FlsSector_1) */
    0U, /* (FlsSector_2) */
...
static CONST(uint8, FLS_CONST) FlsConfigSet_aFlsSectorUnlock[6] =
{
    1U, /* (FlsSector_0) */
    1U, /* (FlsSector_1) */
    1U, /* (FlsSector_2) */
...
static CONST(Fls_AddressType, FLS_CONST) FlsConfigSet_aFlsSectorEndAddr[6] =
{
...
static CONST(Fls_LengthType, FLS_CONST) FlsConfigSet_aFlsProgSize[6] =
{
...
static CONST(Fls_LengthType, FLS_CONST) FlsConfigSet_aFlsSectorPageSize[6] =
{
...
static CONSTP2CONST(Fls_Flash_InternalSectorInfoType, FLS_VAR, FLS_APPL_CONST) FlsConfigSet_aSectorList[6] =
{
...
/* paHwCh[] (FlsConfigSet) */
static CONST(Fls_HwChType, FLS_CONST) FlsConfigSet_paHwCh[6] =
{
...
static CONST(Fls_AddressType, FLS_CONST) FlsConfigSet_paSectorHwAddress[6] =
{
